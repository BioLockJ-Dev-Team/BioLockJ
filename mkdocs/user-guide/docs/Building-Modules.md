...
| logVersion() | Run *exe.classifier* --version to log version info.  [RDP](module.classifier.r16s#RdpClassifier) overrides this method to return null since the version switch is not supported. |
